...
- Make sure you have [WSL2](https://docs.microsoft.com/en-us/windows/wsl/install) installed.
- Make sure you have [Docker for Windows](https://docs.docker.com/desktop/windows/install/) installed. 
- Enable your [Hypervisor service](https://docs.microsoft.com/en-us/virtualization/hyper-v-on-windows/quick-start/enable-hyper-v) in the Windows Control Panel (required for Docker for Windows). 
