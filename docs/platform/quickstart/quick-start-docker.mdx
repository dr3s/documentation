...
## Bring up Redpanda using Docker run
...
## Bring up Redpanda using Docker Compose
...
Use `rpk` to run commands. `rpk` is a CLI tool you can use to work with your Redpanda nodes. See: 
- [Start Streaming](../../install-upgrade/start-streaming)
- [rpk Commands](../../reference/rpk/rpk-topic)
